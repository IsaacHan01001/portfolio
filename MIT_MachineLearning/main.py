...
#-------------------------------------------------------------------------------
#pegasos L =0.01, T = 25, best = 0.8060
# feature_matrix, labels, T, L
# data = (train_bow_features, train_labels, val_bow_features, val_labels)
T = 25
L =0.01

theta, theta_0, train_accuracy, validation_accuracy = p1.classifier_accuracy(p1.pegasos, train_bow_features, test_bow_features, train_labels, test_labels, T = T, L = L)
print(theta)
